...
class RealSenseSource(CameraSource):
    """Intel RealSense depth camera: RGB + aligned depth + intrinsics."""
    ...
    def read(self):
        ...
        # Center dot snaps to the true optical center (camera intrinsic), not
        # just the geometric middle of the frame.
