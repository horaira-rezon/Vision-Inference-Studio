...
class LeftSidebar:
    def __init__(self, parent, app):
        ...
        self.camera_dot = self._section_label_with_dot("1. Inference Input")
        self.camera_btn = ctk.CTkButton(self.sidebar, text="Select Input", command=app.select_camera, font=ctk.CTkFont(size=14))
        self.camera_btn.pack(fill="x", padx=16, pady=(4,2))
        self.model_dot = self._section_label_with_dot("2. Vision Tasks")
        self.model_btn = ctk.CTkButton(self.sidebar, text="Vision Task", command=app.select_vision_task, font=ctk.CTkFont(size=14))
